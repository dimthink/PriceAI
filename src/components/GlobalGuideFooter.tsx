  ...
  return (
    <footer className="bg-[var(--color-page)] px-5 pb-8 pt-4 sm:px-8" aria-label="入门指南入口">
      <div className="mx-auto max-w-[1500px] border-t border-[var(--color-border-soft)] pt-5">
        <Link
          href="/guides"
          className="group mx-auto flex max-w-3xl flex-row items-center justify-between gap-3 rounded-lg bg-[var(--color-panel)] px-4 py-3 text-left ring-1 ring-[var(--color-border-soft)] transition hover:bg-[var(--color-surface-hover)] hover:ring-[var(--color-border-muted)] sm:px-5 sm:py-4"
        >
          <span className="flex min-w-0 items-start gap-3">
            ...
            <span className="min-w-0">
              ...
              <span className="mt-1 hidden text-xs leading-5 text-[var(--color-text-muted)] sm:block">
